...
public class ConnectionUtilCopy {
    private Connection conn = null;
    public ConnectionUtilCopy(String database) {
        try {
        ...
        String url = "jdbc:mysql://" + server + ":"+ port +"/" + database
                + "?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Shanghai&useServerPrepStmts=false&cachePrepStmts=false";
    ...
    public void deleteAnswerAndTiku(String topic_ID) {
        ...
        try (PreparedStatement deleteTikuStmt = conn.prepareStatement(deleteTikuSql)) {
            deleteTikuStmt.setString(1, topic_ID);
            deleteTikuStmt.executeUpdate();
        }catch (SQLException e) {
